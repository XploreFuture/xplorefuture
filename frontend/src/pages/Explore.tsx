...
import entranceExams from "../constants/entranceExam";
...
const Explore: React.FC = () => {
  ...
  // const [detected, setDetected] = useState<ParsedFilters | null>(null);
  ...
  // useEffect(() => {
  //   setDetected(parsedParams);
  //   setFilters((prev) => {
  //     const merged = { ...prev, ...parsedParams, page: 1 };
...
<h2 className="text-xl font-semibold mb-4">{generateHeading()}</h2>
      ...
      <div className="sticky top-20 z-30 bg-white shadow-sm px-4 py-2 overflow-x-auto scrollbar-none">        <div className="flex flex-nowrap gap-4 min-w-max">
              ...
              {colleges.map((college, idx) => (
                ...
                >
                  ...
                  <div className="text-sm text-gray-600 mt-2 grid grid-cols-1 md:grid-cols-2 gap-y-1">
                    ...
                    <p><strong>Avg Fees:</strong> {college.avgFees}</p>
...
//       onChange={onChange}
//       disabled={disabled}
//       className="text-sm w-full p-1 border rounded bg-white"
//     >
